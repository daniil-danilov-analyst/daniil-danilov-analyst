...
|Проект 3 Интерактивный дашборд в Yandex DataLens (Открыть дашборд](https://datalens.yandex/wnkhzyvnzc4gg))|Общие показатели (продажи, индекс удовлетворённости, отзывы с фото/видео) Категориальный анализ (покупки, рейтинг по категориям) Бренды с индексом <80% и динамика Топ худших товаров (оценки, наличие медиа, причины негатива).|SQL,DataLens|
